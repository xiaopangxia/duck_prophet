...
import demjson
import time
from config.news_crawler.qq_news.qq_news_conf import sub_site_dict
...
class QQNewsExtractor():
    """
    qq新闻页解析类,主要是获取标题与链接列表
    """
        ...
        try:
            ...
            for link in link_list_large:
                ...
                if cls.legal_url(link):
                    if ('htm' in link or 'html' in link) and '/a/00000000/' in num_star_str:
